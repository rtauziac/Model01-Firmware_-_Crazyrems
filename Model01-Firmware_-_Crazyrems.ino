...
#define BUILD_INFORMATION "Crazyrems - Custom build"
#endif
...
KEYMAPS(
  ...
  (Key_LeftAlt,  Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_Enter,     Key_Y, Key_U, Key_I,     Key_O,         Key_P,         Key_LeftBracket,
                  Key_H, Key_J, Key_K,     Key_L,         Key_Semicolon, Key_Quote,
   Key_LeftAlt,  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_RightBracket,
...
void setup() {
  ...
  // This is my custom setting for mouse control
  // The default one is too slow
